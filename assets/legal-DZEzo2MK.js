import{K as e,R as t,b as n,g as r,w as i,y as a,z as o}from"./vue-i18n-CcZGMX21.js";import{t as s}from"./marked.esm-Ccg6WR5l.js";var c={class:`legal-document`},l=[`innerHTML`],u=`Varo.cloud — The Port of AI Value`,d=i({__name:`LegalDocument`,props:{content:{},pageTitle:{}},setup(i){let d=i,f=new s.Renderer;f.link=({href:e,title:t,text:n})=>{let r=e??`#`,i=r.startsWith(`http`)||r.startsWith(`mailto:`)||r.startsWith(`//`)?` target="_blank" rel="noopener noreferrer"`:``,a=t?` title="${t}"`:``;return`<a href="${r}"${r.startsWith(`http`)?` class="url"`:``}${a}${i}>${n}</a>`},s.setOptions({gfm:!0,breaks:!0,renderer:f});let p=r(()=>d.content.trim()?s.parse(d.content):``);return e(()=>d.pageTitle,e=>{e&&(document.title=e)},{immediate:!0}),t(()=>{document.title=u}),(e,t)=>(o(),n(`article`,c,[p.value?(o(),n(`div`,{key:0,class:`legal-document__write`,innerHTML:p.value},null,8,l)):a(``,!0)]))}}),f=`# Varo.cloud Privacy Policy
