import{b as e,g as t,w as n,y as r,z as i}from"./vue-i18n-CcZGMX21.js";import{t as a}from"./marked.esm-Ccg6WR5l.js";var o={class:`legal-document`},s=[`innerHTML`],c=n({__name:`LegalDocument`,props:{content:{}},setup(n){let c=n,l=new a.Renderer;l.link=({href:e,title:t,text:n})=>{let r=e??`#`,i=r.startsWith(`http`)||r.startsWith(`mailto:`)||r.startsWith(`//`)?` target="_blank" rel="noopener noreferrer"`:``,a=t?` title="${t}"`:``;return`<a href="${r}"${r.startsWith(`http`)?` class="url"`:``}${a}${i}>${n}</a>`},a.setOptions({gfm:!0,breaks:!0,renderer:l});let u=t(()=>c.content.trim()?a.parse(c.content):``);return(t,n)=>(i(),e(`article`,o,[u.value?(i(),e(`div`,{key:0,class:`legal-document__write`,innerHTML:u.value},null,8,s)):r(``,!0)]))}}),l=`# Varo.cloud Privacy Policy
...
**17.10**. Customer may send us any material notice via email to [support@varo.cloud](mailto:support@varo.cloud).`,d={privacy:{"en-US":l,"zh-CN":l},terms:{"en-US":u,"zh-CN":u}};function f(e,t){return d[e][t]??d[e][`en-US`]}export{c as n,f as t};