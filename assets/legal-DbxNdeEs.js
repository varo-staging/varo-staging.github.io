import{B as e,T as t,_ as n,b as r,x as i}from"./vue-i18n-BL6Rhtrp.js";import{t as a}from"./marked.esm-Ccg6WR5l.js";var o={class:`legal-document`},s=[`innerHTML`],c=t({__name:`LegalDocument`,props:{content:{}},setup(t){let c=t,l=new a.Renderer;l.link=({href:e,title:t,text:n})=>{let r=e??`#`,i=r.startsWith(`http`)||r.startsWith(`mailto:`)||r.startsWith(`//`)?` target="_blank" rel="noopener noreferrer"`:``,a=t?` title="${t}"`:``;return`<a href="${r}"${r.startsWith(`http`)?` class="url"`:``}${a}${i}>${n}</a>`},a.setOptions({gfm:!0,breaks:!0,renderer:l});let u=n(()=>c.content.trim()?a.parse(c.content):``);return(t,n)=>(e(),i(`article`,o,[u.value?(e(),i(`div`,{key:0,class:`legal-document__write`,innerHTML:u.value},null,8,s)):r(``,!0)]))}}),l=`# Varo.cloud Privacy Policy
